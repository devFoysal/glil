        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-success btn-icon m-2" data-toggle="modal" data-target="#addmenu"><i
                        class="fas fa-plus-square"></i>&nbsp; Add Submenu</button>
            </div>
            @if(session('success'))
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" data-toggle="modal"
                                            data-target="#editmenu{{ $submenu->id }}">Edit</a>
                                        <a class="dropdown-item"
                                            href="{{ route('submenu.destroy', ['id' => $submenu->id]) }}">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <!-- Edit Sub menu Modal -->
                        <div class="modal fade" id="editmenu{{ $submenu->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="menu_id" name="menu_id">
                                                    ...
                                                    <option value="{{ $menu->id }}" @if($submenu->menu_id == $menu->id)
                                                        {{ 'selected' }} @endif>{{ $menu->name_en }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="status" name="status">
                                                    ...
                                                    <option value="1" @if($submenu->status == 1) {{ 'selected' }}
                                                        @endif>Active</option>
                                                    <option value="0" @if($submenu->status == 0) {{ 'selected' }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name_en" class="form-control bg-light" type="text" name="name_en"
                            placeholder="Enter Submenu in English">
                    </div>
                    <div class="form-group">
