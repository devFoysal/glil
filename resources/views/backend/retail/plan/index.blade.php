...
@endif
        ...
        <form action="{{ route('retail.plan.add') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="name_bn" class="form-control bg-light  " type="text" name="name_bn" value="{{old('name_bn')}}">
