...
<h5 class="font-weight-normal">Create Retail Plan  For <b>{{$plan->name_en}}</b></h5>
</div>
...
<div class="card-title">Retail Plan Create For  {{$plan->name_en}}</div>
...
@endif
        ...
        <form action="{{ route('retail.planlist.add',['planId'=> $plan->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="">
                <div class="custom-file">
                    
                    <input type="file" name="banner" class="custom-file-input @if($errors->has('banner')) {{'is-invalid'}} @endif" id="banner">
                    <label style="font-size: 1rem !important" class="custom-file-label" for="banner">Choose  List Banner</label>
                ...
                <div class="custom-file mt-3 mb-3">
                    ...
                    <label style="font-size: 1rem !important" class="custom-file-label" for="image">Choose  image</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="name_en" class="form-control bg-light @if($errors->has('name_en')) {{'is-invalid'}} @endif" type="text" name="name_en" value="{{old('name_en')}}">
                 ...
                 <div class="form-group">
                    <label style="font-size: 1rem !important" for="banner_title_en">Banner Title (en)</label>
                        <input id="banner_title_en" class="form-control bg-light @if($errors->has('banner_title_en')) {{'is-invalid'}} @endif" type="text" name="banner_title_en" value="{{old('banner_title_en')}}">
                ...
                name="introduction_en">{{old('introduction_en')}}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    name="feature_en">{{old('feature_en')}}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    name="term_en">{{old('term_en')}}</textarea>
                </div>

                <div class="form-group">
                    <label style="font-size: 1rem !important" for="video_url">Video (url)</label>
                        <input id="video_url" class="form-control bg-light @if($errors->has('video_url')) {{'is-invalid'}} @endif" type="text" name="video_url" value="{{old('video_url')}}">
                ...
                <div class="form-group">
                    ...
                    <input value="{{old('key_1_en')}}" name="key_1_en" type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input value="{{old('key_2_en')}}"  name="key_2_en" type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input value="{{old('key_3_en')}}"  type="text"  name="key_3_en"
                    ...
                    <input value="{{old('key_4_en')}}" type="text" class="form-control" name="key_4_en" id="basic-url" aria-describedby="basic-addon3">
                      </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="name_bn" class="form-control bg-light @if($errors->has('name_bn')) {{'is-invalid'}} @endif" type="text" name="name_bn" value="{{old('name_bn')}}">
                 ...
                 <div class="form-group">
                    <label style="font-size: 1rem !important" for="banner_title_bn">ব্যানার টাইটেল</label>
                        <input id="banner_title_bn" class="form-control bg-light @if($errors->has('banner_title_bn')) {{'is-invalid'}} @endif" type="text" name="banner_title_bn" value="{{old('banner_title_bn')}}">
                ...
                <div class="form-group">
                    ...
                    name="introduction_bn">{{old('introduction_bn')}}</textarea>
                </div>
                ...
                name="feature_bn">{{old('feature_bn')}}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    name="term_bn">{{old('term_bn')}}</textarea>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input name="key_1_bn" type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{old('key_1_bn')}}">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input  value="{{old('key_2_bn')}}" name="key_2_bn" type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input value="{{old('key_3_bn')}}" type="text"  name="key_3_bn"
                        class="form-control" id="basic-url" aria-describedby="basic-addon3">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input value="{{old('key_4_bn')}}" type="text" class="form-control" name="key_4_bn" id="basic-url" aria-describedby="basic-addon3">
                      </div>
            ...
            <div class="form-group
            mt-3">
                <button type="submit" class="btn btn-primary btn-lg">Add New List</button>
            </div>
        </form>
