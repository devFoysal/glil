    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-success btn-icon m-2" data-toggle="modal" data-target="#addmenu"><i class="fas fa-plus-square"></i>&nbsp; Add Menu</button>
            </div>
            @if(session('success'))
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" data-toggle="modal" data-target="#editmenu{{ $menu->id }}">Edit</a>
                                            <a class="dropdown-item" href="{{ route('menu.destroy', ['id' => $menu->id]) }}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                        ...
                                        <form action="{{ route('menu.edit') }}" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input id="name_en" class="form-control bg-light" type="text" name="name_en" value="{{ $menu->name_en }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="name_bn">Menu Name (bn)</label>
                                                    <input id="name_bn" class="form-control bg-light" type="text" name="name_bn" value="{{ $menu->name_bn }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="status" name="status">
                                                        ...
                                                        <option value="0" @if($menu->status == 0) {{ 'selected' }} @endif>Disable</option>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('menu.store') }}" method="post">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="name_en">Menu Name (en)</label>
                    <input id="name_en" class="form-control bg-light" type="text" name="name_en" placeholder="Enter Menu Name in English">
                </div>
                <div class="form-group">
                    <label for="name_bn">Menu Name (bn)</label>
                    <input id="name_bn" class="form-control bg-light" type="text" name="name_bn" placeholder="Enter Menu Name in Bangla">
                </div>
                <div class="form-group">
                    <label for="status">Status</label>
                    <select class="form-control" id="status" name="status">
