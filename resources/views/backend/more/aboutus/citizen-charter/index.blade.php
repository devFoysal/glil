    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Citizen Charter</div>
            </div>
            @if(session('success'))
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="basicDataTable" style="width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            <td><a href="{{asset("uploads/aboutus/$citizenCharter->files")}}" download>Download</a></td>
                            <td>{{Str::limit($citizenCharter->title_en, 30) }}</td>
                            <td>{{Str::limit($citizenCharter->title_bn, 30) }}</td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item"
                                            href="{{route('aboutus.citizenCharter.edit', $citizenCharter->id)}}">Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
