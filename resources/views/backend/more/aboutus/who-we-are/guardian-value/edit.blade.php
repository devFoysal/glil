...
<div class="page-body p-4 text-dark">
    <div class="page-heading border-bottom d-flex flex-row">
        ...
        <small class="mt-2 ml-2">Guardian Value</small>
    </div>
    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Edit Guardian Value</div>
            </div>
            <form action="{{ route('aboutus.whoWeAre.gvUpdate') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <select class="form-control" name="status" id="status">
                            <option value="1" @if($gv->status) {{ 'selected' }}
                                @endif>Active</option>
                            <option value="0" @if(!$gv->status) {{ 'selected' }}
...
<script>
    $(document).ready(function(){
        ...
        $('#description_en').summernote("code", {!! json_encode($gv->description_en) !!});
        $('#description_bn').summernote("code", {!! json_encode($gv->description_bn) !!});
    })
