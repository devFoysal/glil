...
<div class="page-body p-4 text-dark">
    <div class="page-heading border-bottom d-flex flex-row">
        ...
        <small class="mt-2 ml-2">Milestone</small>
    </div>
    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Edit Milestone</div>
            </div>
            <form action="{{ route('aboutus.milestone.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="custom-file mb-3">
                                ...
                                <label class="custom-file-label" for="image">Choose Milestone Image</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <img width="100" src="{{asset("uploads/aboutus/$milestone->image")}}" alt="">
                        </div>
                    </div>
                    <div class="row">
...
<script>
    $(document).ready(function(){
        ...
        $('#description_en').summernote("code", {!! json_encode($milestone->description_en) !!});
        $('#description_bn').summernote("code", {!! json_encode($milestone->description_bn) !!});
    })
