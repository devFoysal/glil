...
<div class="page-body p-4 text-dark">
    <div class="page-heading border-bottom d-flex flex-row">
        ...
        <small class="mt-2 ml-2">Team Heading</small>
    </div>
    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Edit Team Heading</div>
            </div>
            <form action="{{ route('aboutus.managementTeam.update-heading') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$mTeamHeading->id}}">
                <div class="modal-body">
                    <div class="row">

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_en">Heading (en)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_bn">Heading (bn)</label>
...
<script>
    $(document).ready(function(){
        ...
        $('#description_en').summernote("code", {!! json_encode($mTeamHeading->description_en) !!});
        $('#description_bn').summernote("code", {!! json_encode($mTeamHeading->description_bn) !!});
    })
