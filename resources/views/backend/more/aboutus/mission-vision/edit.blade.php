    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Edit Mission Vision</div>
            </div>
            <form action="{{ route('aboutus.missionVision.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_en">Mission Vision (en)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_bn">Mission Vision (bn)</label>
                    ...
                    <div class="form-group mt-4">
                        ...
                        <select class="form-control" name="status" id="status">
                            <option value="1" @if($missionVision->status) {{ 'selected' }}
                                @endif>Active</option>
                            <option value="0" @if(!$missionVision->status) {{ 'selected' }}
...
<script>
    $(document).ready(function(){
        ...
        $('#description_en').summernote("code", {!! json_encode($missionVision->description_en) !!});
        $('#description_bn').summernote("code", {!! json_encode($missionVision->description_bn) !!});
    })
