    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Add Chairman Speech</div>
            </div>
            <form action="{{ route('aboutus.ourChairman.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_en">Speech (en)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="description_bn">Speech (bn)</label>
