...
<div class="page-body p-4 text-dark">
    <div class="page-heading border-bottom d-flex flex-row">
        ...
        <small class="mt-2 ml-2">Chairman</small>
    </div>
    ...
    <div class="card mt-4 rounded-lg">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div class="card-title">Chairman</div>
            </div>
            @if(session('success'))
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="basicDataTable" style="width: 100%;">
                    ...
                    <!-- Table body -->
                    <tbody>
                        @foreach ($chairmanSpeech as $index => $cs)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{Str::limit($cs->description_en, 30) }}</td>
                            <td>{{Str::limit($cs->description_bn, 30) }}</td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item"
                                            href="{{route('aboutus.ourChairman.edit', $cs->id)}}">Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
