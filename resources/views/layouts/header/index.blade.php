...
<head>
    ...
    <!-- fontawesome -->
    <script src="https://kit.fontawesome.com/e4970535a3.js" crossorigin="anonymous"></script>
                    ...
                    <div class="col-12 text-right">
                        ...
                        <li class="{{count($menu->submenus) > 0 ? 'd' : ''}}">
                            {{-- <a class="main-link" href="{{route($menu->slug_en,app()->getLocale())}}"
                                ...
                                <a class="main-link" href="{{$menu->slug_en != '#' || $menu->slug_en != '' ? URL::to(app()->getLocale()) . '/'. $menu->slug_en : 'abc'}}" title="Click Here to go Retail Page">
                                @if ($Bn)
                                {{$menu->name_bn}}
                                @else
                                {{$menu->name_en}}
                                ...
                                <div class="dropdown" style="z-index: 500">
                                    ...
                                    <a class="dropdown-item" href="{{$menu->slug_en == '#' || $menu->slug_en == '' ? '/'. app()->getLocale() .'/' . $submenu->slug_en : '/'. app()->getLocale() .'/'. $menu->slug_en. '/' . $submenu->slug_en }}">
                                        @if ($Bn)
                                        {{$submenu->name_bn}}
                                        @else
                                        {{$submenu->name_en}}
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-bg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{route('corporate', app()->getLocale())}}"
                            id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            Corporate
                        </a>
    ...
    <div id="social-sidebar">
        ...
        <ul>
            ...
            <li><a href="#" class="entypo-self" style="border-top: 0.5px solid #C6781B" data-toggle="tooltip"
                    data-placement="left" title="Policy Information"><img src={{asset('assets/img/card.png')}}
                        alt=""><span><i></i></span></a></li>
            <li><a href="#" class="entypo-self" style="border-top: 0.5px solid #C6781B" data-toggle="tooltip"
                    data-placement="left" title="Claim Settlement"><img src={{asset('assets/img/date.png')}}
                        alt=""><span><i></i></span></a></li>
            <li><a href="" class="entypo-self a2a_dd" style="border-top: 0.5px solid #C6781B" data-toggle="tooltip"
                    data-placement="left" title="Book an Appointment"><i class="far fa-calendar-alt"></i></a></li>
        </ul>
    </div>