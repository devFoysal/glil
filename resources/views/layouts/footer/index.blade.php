        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 logo-section">
                    <img src="{{asset("assets/img/home/footerlogo.png")}}" alt="" class="img-fluid" />
                    <p class="pt-3">Our Sponsor</p>
                    <div class="sponsors">
                        <img src="{{asset("assets/img/home/sponsor1.png")}}" alt="" class="img-fluid" />
                        <img src="{{asset("assets/img/home/sponsor2.png")}}" alt="" class="img-fluid" />
                        <img src="{{asset("assets/img/home/sponsor3.png")}}" alt="" class="img-fluid" />
                    </div>
                ...
                <div class="col-lg-5 mt-4">
                    ...
                    <div class="quick-links">
                        ...
                        <div>
                            ...
                            <li>
                                <a href="{{route('newsEvent', app()->getLocale())}}">
                                    News
                                </a>
                            </li>
                            <li>
