...
@section("title", "Guardian Somriddhi")
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1> 
                    <span class="ml-0"> Guardian Somriddhi </span>
                </h1>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8">
                <div class="key-benefits mb-4">
                    <div class="row key-benefits-inner mx-0 align-items-center">
                        <div class="col-md-2">
                            <h5>Lower premium; higher protection</h5>
                        </div>
                        ...
                        <div class="col-md-2">
                            <h5>Pay less & get most out of your policy</h5>
                        </div>
                        <div class="col-md-1 img-line">
                            <img src="{{asset("assets/img/bancasurance/line.png")}}" alt="">
                        </div>
                        <div class="col-md-2">
                            <h5>A Term plan that is just like endowment Insurance</h5>
                        </div>
                    </div>
                </div>
                <div class="left-side">
                        ...
                        <div class="col-md-9 ash-main-bg">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p>The simplest Insurance plan that allows you to cut out all the frills and maximize your Insurance Coverage at the most affordable premiums.</p>
                                            ...
                                            <p>Get both Insurance & Guaranteed Savings at the least possible premiums for the coverage amount.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            ...
                                            <p>[8] Critical Illness Coverage: 18 Critical Illness Coverage for self upto 10 Lac.</p>
                                        </div>
                                    </div>
                                </div>
