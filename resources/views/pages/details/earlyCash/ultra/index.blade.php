...
@section("title", "Guardian Care Ultra")
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1> 
                    Guardian Care<span class="ml-0"> Ultra (5 Stage) </span>
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-9 ash-main-bg">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p>The wise one’s priority plan: A liquid savings plan that will give back partial sum assured in five different time periods for attaining your precious dreams at various stages of life.</p>
                                            <p>Now, you can have insurance, savings and also cherish those major milestones of life. A Guardian Five-Stage Plan can help you to address most of those milestones:</p>
                                            ...
                                            <li>Even redo your home décor or even fund your child’s marriage!</li>
                                            <li>Plan for the down payment of your home</li>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Term of insurance plan:</strong> 10, 15, 20, 25 or 30 years</p>
                                            <br>
                                            ...
                                            <p>[1] The sum assured will be paid in five installments, with earned bonus / profit, four before the maturity of the insurance plan and the fifth at the expiration of the plan.</p>
                                            <p>[a] In the first phase, 10% of the basic sum assured, one-fifth of the maturity period.</p>
                                            <p>[b] In the second phase, next 15% of the sum assured, two-fifth of the maturity period</p>
                                            <p>[c] Third phase, next 20% of the sum assured, three-fifth of the maturity period</p>
                                            <p>[d] Fourth phase, next 25% of the sum assured, four-fifth of the maturity period</p>
                                            <p>[e] In the fifth phase (end), the remaining 30% of the basic sum assured and the bonus / profit will be paid</p>
                                            ...
                                            <p>[3] Upon maturity of the insurance plan, the policyholder will get the survival benefit, which is the fourth phase of the pay-out. Remaining 30% of the sum assured in the fourth phase will be paid along with the bonus / profit earned.</p>
