...
@section("title", "Guardian Care Free")
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1> 
                    Guardian Care<span class="ml-0"> Free (3 Stage) </span>
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-9 ash-main-bg">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p>Meet your priorities: A liquid savings plan that will give back partial sum assured in three different time periods for attaining your precious dreams at various stages of life.</p>
                                            <p>Now, you can have insurance, savings and also cherish those major milestones of life</p>
                                            <p>A Guardian Three-Stage Plan can help you to meet all those needs at the various stages of life:</p>
                                            <li>Plan your goals with a lump sum pay out at maturity</li>
                                            <li>Secure your family’s future</li>
                                            <li>Finance your Honeymoon</li>
                                            <li>Fund your vacations</li>
                                            <li>Meet important milestones of your Child’s education</li>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Term of insurance plan:</strong> 12, 15, 18, 21 or 24 years</p>
                                            <br>
                                            ...
                                            <p>[a] In the first phase, 25% of the basic sum assured, one-third of the maturity period.</p>
                                            <p>[b] In the second phase, next 25% of the basic sum assured, two-thirds of the maturity period</p>
                                            <p>[c] In the third phase, the remaining 50% of the basic sum assured and the bonus / profit will be paid</p>
                                            <p>[2] Upon receiving the first or second pay-out, if the policyholder dies before the expiry of the plan, then the nominee will be provided with the full sum assured along with the earned bonus / profit.</p>
                                            <p>[3] Upon maturity of the insurance plan, the policyholder will get the survival benefit, which is the third phase of the pay-out. Remaining 50% of the sum assured in the third phase will be paid along with the bonus / profit earned.</p>
