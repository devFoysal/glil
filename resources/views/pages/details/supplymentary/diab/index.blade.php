...
@section("title", "Double Indemnity & Accidental Benefit")
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1> 
                    <span class="ml-0"> Double Indemnity & <br> Accidental Benefit </span>
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-9 ash-main-bg">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Features and benefits of Double Indemnity & Accidental Benefit includes:</strong></p>
                                            <li>Benefits upto 2 Times of Coverage Amount</li>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Terms & Conditions of Double Indemnity & Accidental Benefit:</strong></p>
