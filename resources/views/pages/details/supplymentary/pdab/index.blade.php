...
@section("title", "Permanent Disability & Accidental Benefit")
@section("content")
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <h1> 
                    <span class="ml-0"> Permanent Disability & <br> Accidental Benefit </span>
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-9 ash-main-bg">
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            ...
                                            <p>Waiver of future all premiums for disablement from engaging in or giving attention to any employment or occupation whether for purposes of business, profession or otherwise.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Features and benefits of Permanent Disability & Accidental Benefit includes:</strong></p>
                                            <li>Accidental Death Coverage 100% of the SA but not more than BDT 30 Lac</li>
                                            <li>Permanent Total Disablement [PTD] Coverage 100% of the SA but not more than BDT 30 Lac</li>
                                            <li>Proportionate Permanent Partial Disablement [PPD] Coverage</li>
                                            <li>Waiver of all future premium</li>
                                            <li>Guaranted annuity for 10 years</li>
                                            <li>Convenient Premium Payment Options [same as base plan]</li>
                                            <li>Enjoy attractive discounts at our partner hospitals & clinical labs with Guardian Life Card</li>
                                ...
                                >
                                    <div>
                                        <div class="col">
                                            <p><strong>Terms & Conditions of Permanent Disability & Accidental Benefit:</strong></p>
                                            <li>PDAB & DIAB is mutually exclusive</li>
